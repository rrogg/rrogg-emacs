...
=NONGNU= and =MELPA= are added to the archive list.
...
Emacs can't render the epub format out of the box. A package called =nov.el=
adds support for it.

#+begin_src emacs-lisp
(rrogg-emacs-elpa-package 'nov
  (setq nov-text-width 80)
  (add-to-list 'auto-mode-alist '("\\.epub\\'" . nov-mode)))
#+end_src

=nov.el= requires the Linux package =unzip= to be installed.
